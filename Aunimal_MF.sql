...
-- -----------------------------------------------------
DROP SCHEMA IF EXISTS `aunimal_hotel_pet` ;
...
CREATE TABLE IF NOT EXISTS `aunimal_hotel_pet`.`cliente` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_cliente_pessoa1_idx` (`id` ASC) INVISIBLE,
  INDEX `fk_cliente_pet_idx` (`id_pet` ASC) VISIBLE,
  CONSTRAINT `fk_cliente_pessoa1`
    FOREIGN KEY (`id`)
    REFERENCES `aunimal_hotel_pet`.`pessoa` (`id`)
    ON DELETE RESTRICT
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_cliente_pet`
    FOREIGN KEY (`id_pet`)
...
CREATE TABLE IF NOT EXISTS `aunimal_hotel_pet`.`cobranca` (
  ...
  `id_funcinario` INT UNSIGNED NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_cobranca_reserva_idx1` (`id_reserva` ASC) VISIBLE,
  INDEX `fk_cobranca_cliente_idx` (`id_cliente` ASC) VISIBLE,
  INDEX `fk_cobranca_funcionario_idx` (`id_funcinario` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `aunimal_hotel_pet`.`funcionario` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_funcionario_pessoa1_idx` (`id` ASC) INVISIBLE,
...
CREATE TABLE IF NOT EXISTS `aunimal_hotel_pet`.`pessoa` (
  ...
  INDEX `fk_pessoa_endereco_idx` (`id_endereco` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `aunimal_hotel_pet`.`reserva` (
  ...
  `id_cliente` INT UNSIGNED NOT NULL,
  `id_funcionario` INT UNSIGNED NOT NULL,
  PRIMARY KEY (`id`, `id_funcionario`, `id_cliente`),
