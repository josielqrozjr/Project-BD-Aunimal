...
class Cobranca_forma(Base):
    ...
    id_cobranca: Mapped[int] = mapped_column("id_cobranca", INTEGER,ForeignKey(Cobranca.id), nullable=False)
    id_forma: Mapped[int] = mapped_column("id_forma", INTEGER,ForeignKey(Forma.id), nullable=False)